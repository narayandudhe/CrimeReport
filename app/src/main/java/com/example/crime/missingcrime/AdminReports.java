...
//        inflater.inflate(R.menu.main_menu, menu);
    ...
    public boolean isServicesOK(){
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(AdminReports.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(AdminReports.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
    ...
    void signOut()
    {
        ...
        Intent intent = new Intent(AdminReports.this, SignInActivity.class);
...
//                });
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intentUserList = new Intent(AdminReports.this, ApproveViewActivity.class);
    ...
    private void setAdapter(final String searchedString) {
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                searchAdapter = new SearchAdapter(AdminReports.this, title, location,range,key,logoHotel);
